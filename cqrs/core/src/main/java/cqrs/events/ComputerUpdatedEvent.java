...
public class ComputerUpdatedEvent
{
    ...
    public ComputerUpdatedEvent(ComputerId computerId, String name, Date introduced, Date discontinued, CompanyId companyId)
    {
