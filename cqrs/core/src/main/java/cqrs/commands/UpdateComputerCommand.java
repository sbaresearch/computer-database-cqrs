...
public class UpdateComputerCommand
{
    ...
    public UpdateComputerCommand(ComputerId computerId, String name, Date introduced, Date discontinued, CompanyId companyId)
    {
